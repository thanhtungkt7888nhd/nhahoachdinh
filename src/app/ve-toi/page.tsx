...
const teachers: { stt: string; name: string; desc: string; img?: string }[] = [
  ...
  { stt: "02", name: "Thầy Giản Tư Trung", desc: "Tư duy quản trị mục tiêu cuộc đời — kinh doanh là hành trình tu thân, không chỉ là kiếm tiền.", img: "/images/teacher-gian-tu-trung.webp" },
