...
/* ══════════════════════════════════════════════════ */
export default function XVFMainClient() {
      ...
      >
        ...
        <section className="xvf-pattern-squares" style={{ padding: "6rem 1.5rem 4rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
          ...
          >
            ...
            >
              3 MÙA ĐÃ QUA · 100+ FARM · 30+ TỈNH THÀNH
            </span>
          </motion.div>
          ...
          <div style={{ maxWidth: "900px", margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.25rem" }}>
              {[
                ...
                { year: "2025", label: "Lần 3", route: "QL1A · 35 farm · 15 ngày", desc: "Quy mô lớn nhất, dọc theo Quốc lộ 1A xuyên suốt.", status: "done", href: "/xuyen-viet-farmstay/2025" },
                { year: "2026", label: "Lần 4 · Đang mở", route: "Đang lên kế hoạch", desc: "Hãy là một phần của hành trình lịch sử tiếp theo.", status: "open", href: "/xuyen-viet-farmstay/2026" },
              ].map((t, i) => (
                <motion.a
                  key={t.year}
                  href={t.href}
                  ...
                  style={{
                    ...
                    border: t.status === "open" ? "1px solid rgba(196,154,40,0.5)" : "1px solid rgba(196,154,40,0.2)",
                    borderRadius: "14px",
                    padding: "1.75rem",
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.75rem" }}>
                    <span style={{ ...goldShimmerStyle, fontFamily: "var(--font-alegreya)", fontSize: "2rem", fontWeight: 700 }}>{t.year}</span>
                    <span style={{
                      background: t.status === "open" ? "rgba(196,154,40,0.2)" : "rgba(40,120,60,0.25)",
                      color: t.status === "open" ? "#C49A28" : "#6DBF7E",
                      fontFamily: "var(--font-nunito)",
                      fontSize: "8px",
                      ...
                      padding: "3px 10px",
                      borderRadius: "100px",
                      border: `1px solid ${t.status === "open" ? "rgba(196,154,40,0.3)" : "rgba(40,120,60,0.3)"}`,
                    }}>
                      {t.status === "open" ? "ĐĂNG KÝ" : "ĐÃ QUA"}
                    </span>
                  </div>
                  <p style={{ color: "#EDE0C4", fontFamily: "var(--font-nunito)", fontSize: "11px", fontWeight: 700, letterSpacing: "0.05em", marginBottom: "0.5rem" }}>{t.route}</p>
                  <p style={{ color: "rgba(212,200,164,0.65)", fontFamily: "var(--font-nunito)", fontSize: "12px", lineHeight: 1.6, margin: "0 0 1rem" }}>{t.desc}</p>
                  <span style={{ color: "#C49A28", fontFamily: "var(--font-nunito)", fontSize: "10px", letterSpacing: "0.15em", textTransform: "uppercase" }}>
                    {t.status === "open" ? "Đăng ký →" : "Xem hành trình →"}
                  </span>
                </motion.a>
              ))}
            </div>
